...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/02/03 16:24:30 by aidrissi          #+#    #+#             */
/*   Updated: 2020/02/28 18:45:26 by aidrissi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../cub.h"

int				check_atoi_er(char **tab, int k)
{
	int i;
...
{
	if (!p->w && !p->h && nbr_ch(t) == 3 && !ft_cmpr(t[0], "R"))
	...
	else if (!p->s && nbr_ch(t) == 2 && !ft_cmpr(t[0], "S"))
	{
